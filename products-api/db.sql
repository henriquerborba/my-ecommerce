...
INSERT INTO
    `my-ecommerce`.`categories` (`id`, `name`)
VALUES (
        "6b4c28f4-6831-495a-9444-19c93452faa3", "Relogios"
    );

INSERT INTO
    `my-ecommerce`.`categories` (`id`, `name`)
VALUES (
        "7c0ca0d4-ff23-4bd7-b131-c563067c4b43", "Eletronicos"
    );
...
VALUES (
        "7f8c9d8e-9f0a-1b2c-3d4e-5f6g7h8i9j0k", "Product 1", "Description 1", 100, "6b4c28f4-6831-495a-9444-19c93452faa3", "http://localhost:9000/products/1.png"
    ),
    (
